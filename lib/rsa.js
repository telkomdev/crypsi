 ...
 * keyType option value: 'private', 'public'
 * @param keyType {string>}
 * @param data {string | Buffer}
 * @return {string | Buffer}
 */
const loadKeyFromBase64 = (keyType, data) => {
    data = bufferToString(data);
    data = Buffer.from(data, 'base64').toString();
    switch (keyType) {
        case 'private':
            data = this.loadPrivateKey(data);
            break
        case 'public':
            data = this.loadPublicKey(data)
            break;
    }
    return data;
}
...
exports.loadPrivateKeyFromBase64 = (data) => {
    return loadKeyFromBase64('private', data);
};
...
exports.loadPublicKeyFromBase64 = (data) => {
    return loadKeyFromBase64('public', data);
};
